...
function openMenu() {
  return new Promise((resolve) => {
    $(".js-toggle-menu").addClass("is-disabled").attr("disabled", true);
    ...
    setTimeout(() => {
      ...
      $(".js-toggle-menu").removeClass("is-disabled").attr("disabled", false);
...
function init() {
  ...
  $(".js-toggle-menu").on("click.header", toggleMenu);
